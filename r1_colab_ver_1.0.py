...
class Trader:
  ...
  amethystBuyIn = [0, 1, 100, 9, 27, 40] # A test array that determines how much should be bought based on price
  ...
  def DoAmethystTrading(self, state: TradingState):
    ...
    for buyOrder in orderDepth.buy_orders:
      ...
      if int(bidPrice) > median: # If they are paying above the median
        ...
        # Adjust stored amethyst variables based on the order Helllllll
